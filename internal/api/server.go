...
func (s *Server) setupRoutes() {
	...
	v1.Use(authMiddleware, codexGroupAccessMiddleware, proxyOnlyMiddleware, publicProtectionMiddleware)
	{
		...
		// These compatibility aliases keep misconfigured bases like ".../v1" or
		// ".../v1/messages" working instead of failing with a 404.
		v1.GET("/v1/models", claudeModelsHandler)
		v1.GET("/messages/v1/models", claudeModelsHandler)
		v1.GET("/models/v1/models", claudeModelsHandler)
		v1.GET("/models/claude", claudeCodeHandlers.ClaudeModels)
		v1.GET("/v1/models/claude", claudeCodeHandlers.ClaudeModels)
		v1.GET("/messages/v1/models/claude", claudeCodeHandlers.ClaudeModels)
		v1.GET("/models/v1/models/claude", claudeCodeHandlers.ClaudeModels)
		v1.POST("/chat/completions", openaiHandlers.ChatCompletions)
		v1.POST("/completions", openaiHandlers.Completions)
		v1.POST("/messages", claudeCodeHandlers.ClaudeMessages)
		v1.POST("/v1/messages", claudeCodeHandlers.ClaudeMessages)
		v1.POST("/messages/v1/messages", claudeCodeHandlers.ClaudeMessages)
		v1.POST("/messages/count_tokens", claudeCodeHandlers.ClaudeCountTokens)
		v1.POST("/v1/messages/count_tokens", claudeCodeHandlers.ClaudeCountTokens)
		v1.POST("/messages/v1/messages/count_tokens", claudeCodeHandlers.ClaudeCountTokens)
